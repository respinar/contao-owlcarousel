...
$GLOBALS['TL_LANG']['tl_module']['owl_dotsEach']           = array('Dots each','Show dots each x item.');
$GLOBALS['TL_LANG']['tl_module']['owl_dotsSpeed']          = array('Dots speed','Pagination speed.');
$GLOBALS['TL_LANG']['tl_module']['owl_autoplay']           = array('Autoplay','Autoplay');
$GLOBALS['TL_LANG']['tl_module']['owl_autoplayHoverPause'] = array('Autoplay hover pause','Pause on mouse hover.');
$GLOBALS['TL_LANG']['tl_module']['owl_autoplaySpeed']      = array('Autoplay speed','Autoplay speed.');
$GLOBALS['TL_LANG']['tl_module']['owl_autoplayTimeout']    = array('Autoplay timeout','Autoplay interval timeout.');
$GLOBALS['TL_LANG']['tl_module']['owl_smartSpeed']         = array('Smart speed','Speed Calculate.');
$GLOBALS['TL_LANG']['tl_module']['owl_fluidSpeed']         = array('Fluid speed','Speed Calculate.');
$GLOBALS['TL_LANG']['tl_module']['owl_animateIn']          = array('Animate in','Class for CSS3 animation in.');
$GLOBALS['TL_LANG']['tl_module']['owl_animateOut']         = array('Animate out','Class for CSS3 animation out.');

/**
 * Legends
 */
$GLOBALS['TL_LANG']['tl_module']['owlcarousel_legend'] = 'Owl carousel';
$GLOBALS['TL_LANG']['tl_module']['owl_options_legend'] = 'Owl carousel Options';
$GLOBALS['TL_LANG']['tl_module']['owl_merge_legend'] = 'Merge options';
$GLOBALS['TL_LANG']['tl_module']['owl_nav_legend']   = 'Navigation options';
$GLOBALS['TL_LANG']['tl_module']['owl_dots_legend'] = 'Pagnation options';
$GLOBALS['TL_LANG']['tl_module']['owl_autoplay_legend'] = 'Autoplay options';
$GLOBALS['TL_LANG']['tl_module']['owl_animate_legend'] = 'Animation options';